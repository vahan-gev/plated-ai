...
export default function NewGroupPage() {
    ...
    const canProceed = () => {
        switch (step) {
            ...
            case 3:
                return data.colorGrade !== "";
            case 4:
                return data.surfaceImage !== "";
            case 5:
                return data.shotAngle !== "";
            default:
                return false;
        }
    };
                        ...
                        {step === 0 && (
                            <div className="max-w-lg mx-auto text-center">
                                ...
                                <p className="text-muted-foreground mb-8">
                                    Give this batch a descriptive name, like
                                    "Lunch Menu" or "Summer Desserts".
                                </p>
                                <input
                                    type="text"
                                    value={data.name}
                            ...
                            <div>
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        Select the dimensions for your generated
                                        images.
                                    </p>
                                </div>
                                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
                                    {ASPECT_RATIO_OPTIONS.map((opt) => (
                                        <button
                                            ...
                                            className={`option-card p-5 rounded-xl border text-left transition-all flex items-start gap-4 ${
                        ...
                        {step === 2 && (
                            <div>
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        Select the lighting style for all dishes
                                        in this group.
                                    </p>
                                </div>
                        ...
                        {step === 3 && (
                            <div>
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        Select the color grading style for your
                                        photos.
                                    </p>
                                </div>
                                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-3xl mx-auto">
                        ...
                        {step === 4 && (
                            <div>
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        Select the tablecloth or surface your
                                        dishes will sit on.
                                    </p>
                                </div>
                                        ...
                                        <button
                                            ...
                                            className={`option-card rounded-xl overflow-hidden border aspect-square relative ${
                                                data.surfaceImage === name
                                                    ? "selected ring-2 ring-[#215E61]"
                                                    : "border-border"
                                            }`}
                                        >
                                            <Image
                                                src={`/assets/tablecloths/${name}.png`}
                                                alt={name}
                                                fill
                        ...
                        {step === 5 && (
                            <div>
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-muted-foreground">
                                        Select the camera angle for your menu
                                        photos.
                                    </p>
                                </div>
